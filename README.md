...
thickness. Estimating the *effective* elastic thickness (T<sub>e</sub>) of the lithosphere 
(thickness 
...
estimation techniques - however, to map T<sub>e</sub> variations it is important to use
