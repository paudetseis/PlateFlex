...
(<p style="font-family:times;"><i>T<sub>e</sub></i></p>) of the lithosphere (thickness 
...
estimation techniques - however, to map <p style="font-family:times;"><i>T<sub>e</sub></i></p> 
